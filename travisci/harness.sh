...
export PERL5LIB=$PWD/lib:$PWD/ensembl/modules:$PWD/ensembl-funcgen/modules:$PWD/ensembl-hive/modules:$PWD/ensembl-metadata/modules:$PWD/ensembl-test/modules:$PWD/ensembl-variation/modules:$PWD/ensembl-compara/modules:$PWD/bioperl-live
