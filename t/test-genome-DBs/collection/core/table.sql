...
) ENGINE=MyISAM AUTO_INCREMENT=435 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
) ENGINE=MyISAM AUTO_INCREMENT=817 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80 CHECKSUM=1;
...
) ENGINE=MyISAM AUTO_INCREMENT=42996 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
) ENGINE=MyISAM AUTO_INCREMENT=42966 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
) ENGINE=MyISAM AUTO_INCREMENT=559 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=605023 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1509649 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
) ENGINE=MyISAM AUTO_INCREMENT=3301 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=41639 DEFAULT CHARSET=latin1 CHECKSUM=1;
...
) ENGINE=MyISAM AUTO_INCREMENT=653968 DEFAULT CHARSET=latin1 CHECKSUM=1;
