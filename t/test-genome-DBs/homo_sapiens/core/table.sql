...
) ENGINE=MyISAM AUTO_INCREMENT=29215792 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
) ENGINE=MyISAM AUTO_INCREMENT=3931433 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=50857 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=325095 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=5905 DEFAULT CHARSET=latin1;
...
CREATE TABLE `misc_feature` (
  ...
  KEY `seq_region_idx` (`seq_region_id`,`seq_region_start`)
) ENGINE=MyISAM AUTO_INCREMENT=7277795 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=28695418 DEFAULT CHARSET=latin1;
...
CREATE TABLE `protein_align_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `external_db_idx` (`external_db_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10637112 DEFAULT CHARSET=latin1 MAX_ROWS=100000000 AVG_ROW_LENGTH=80;
...
CREATE TABLE `protein_feature` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=16374924 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=612018 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=1001427460 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=205511 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transcript` (
  ...
  KEY `analysis_idx` (`analysis_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=1132268 DEFAULT CHARSET=latin1;
...
CREATE TABLE `translation` (
  ...
  KEY `transcript_idx` (`transcript_id`),
  KEY `stable_id_idx` (`stable_id`,`version`)
) ENGINE=MyISAM AUTO_INCREMENT=1475324 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=10635493 DEFAULT CHARSET=latin1;
